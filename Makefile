#############################################################################
# Makefile for building: DE_CP1
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  DE_CP1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile DE_CP1.pro
#############################################################################
...
INCPATH       = -I. -I. -I/usr/include/qt -I/usr/include/qt/QtCharts -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I. -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = DE_CP11.0.0
DISTDIR = /home/tea/Documents/GitHub/DE_CP1/.tmp/DE_CP11.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) /usr/lib/libQt5Charts.so /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: DE_CP1.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Exact.h Function.h Grid.h MyExact.h nesting.h $(DISTDIR)/
	$(COPY_FILE) --parents Exact.cpp Function.cpp Grid.cpp main.cpp MyExact.cpp nesting.cpp Point.cpp $(DISTDIR)/
...
main.o: main.cpp nesting.h \
		Exact.h \
		Grid.h \
		Function.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

MyExact.o: MyExact.cpp Exact.h \
		Grid.h \
		Function.h \
		MyExact.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MyExact.o MyExact.cpp

nesting.o: nesting.cpp nesting.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o nesting.o nesting.cpp
